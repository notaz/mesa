 ...
 * patch.c++
 *
 * $Date: 2006/03/14 15:09:16 $ $Revision: 1.3.26.1 $
 * $Header: /home/krh/git/sync/mesa-cvs-repo/Mesa/src/glu/sgi/libnurbs/internals/patch.cc,v 1.3.26.1 2006/03/14 15:09:16 brianp Exp $
 */
