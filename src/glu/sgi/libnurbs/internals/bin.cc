 ...
 * bin.c++
 *
 * $Date: 2006/03/14 15:09:16 $ $Revision: 1.2.8.1 $
 * $Header: /home/krh/git/sync/mesa-cvs-repo/Mesa/src/glu/sgi/libnurbs/internals/bin.cc,v 1.2.8.1 2006/03/14 15:09:16 brianp Exp $
 */
