 ...
 * glcurveval.c++
 *
 * $Date: 2003/04/30 15:20:07 $ $Revision: 1.4.2.1 $
 * $Header: /home/krh/git/sync/mesa-cvs-repo/Mesa/src/glu/sgi/libnurbs/interface/glcurveval.cc,v 1.4.2.1 2003/04/30 15:20:07 brianp Exp $
 */
