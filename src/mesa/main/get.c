...
_mesa_GetBooleanv( GLenum pname, GLboolean *params )
{
   ...
   switch (pname) {
      ...
      case GL_OCCLUSION_TEST_HP:
         CHECK_EXT1(HP_occlusion_test, "GetBooleanv");
      ...
      case GL_PIXEL_TEXTURE_SGIS:
         CHECK_EXT1(SGIS_pixel_texture, "GetBooleanv");
         params[0] = ctx->Pixel.PixelTextureEnabled;
         break;
      case GL_PIXEL_TEX_GEN_SGIX:
         CHECK_EXT1(SGIX_pixel_texture, "GetBooleanv");
         params[0] = ctx->Pixel.PixelTextureEnabled;
         break;
...
_mesa_GetFloatv( GLenum pname, GLfloat *params )
{
   ...
   switch (pname) {
      ...
      case GL_TRANSPOSE_TEXTURE_MATRIX_ARB:
         ...
         break;
      case GL_OCCLUSION_TEST_HP:
         CHECK_EXT1(HP_occlusion_test, "GetFloatv");
      ...
      case GL_OCCLUSION_TEST_RESULT_HP:
         ...
         break;
      case GL_PIXEL_TEXTURE_SGIS:
         CHECK_EXT1(SGIS_pixel_texture, "GetFloatv");
         params[0] = BOOLEAN_TO_FLOAT(ctx->Pixel.PixelTextureEnabled);
         break;
      case GL_PIXEL_TEX_GEN_SGIX:
         CHECK_EXT1(SGIX_pixel_texture, "GetFloatv");
         params[0] = BOOLEAN_TO_FLOAT(ctx->Pixel.PixelTextureEnabled);
         break;
      case GL_PIXEL_TEX_GEN_MODE_SGIX:
         CHECK_EXT1(SGIX_pixel_texture, "GetFloatv");
...
_mesa_GetIntegerv( GLenum pname, GLint *params )
{
   ...
   switch (pname) {
      ...
      case GL_TRANSPOSE_TEXTURE_MATRIX_ARB:
         ...
         break;
      case GL_OCCLUSION_TEST_HP:
         CHECK_EXT1(HP_occlusion_test, "GetIntegerv");
      ...
      case GL_OCCLUSION_TEST_RESULT_HP:
         ...
         break;
      case GL_PIXEL_TEXTURE_SGIS:
         CHECK_EXT1(SGIS_pixel_texture, "GetIntegerv");
         params[0] = BOOLEAN_TO_INT(ctx->Pixel.PixelTextureEnabled);
         break;
      case GL_PIXEL_TEX_GEN_SGIX:
         CHECK_EXT1(SGIX_pixel_texture, "GetIntegerv");
         params[0] = BOOLEAN_TO_INT(ctx->Pixel.PixelTextureEnabled);
         break;
      case GL_PIXEL_TEX_GEN_MODE_SGIX:
         CHECK_EXT1(SGIX_pixel_texture, "GetIntegerv");
